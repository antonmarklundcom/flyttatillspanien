...
export const sv = {
  ...
  priceAlertEmailPlaceholder: "Din e-postadress",
  priceAlertSubmit: "Bevaka",
  priceAlertSending: "…",
  priceAlertDone: "✓ Klart, vi hör av oss om priset sänks",
  wizardNext: "Nästa →",
...
export const svPanel = {
  ...
  adminAgenciesEmpty: "Inga mäklarbyråer ännu.",
  adminIndependentAgent: "Fristående agent",
  colName: "Namn",
  colPlan: "Plan",
  colContact: "Kontakt",
  colStatus: "Status",
  colAgency: "Mäklarbyrå",
