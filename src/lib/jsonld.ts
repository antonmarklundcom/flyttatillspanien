...
export function listingJsonLd(origin: string, detail: ListingDetail): object {
  ...
  return {
    ...
    address: {
      ...
      addressRegion: chain.find((c) => c.level === "provincia")?.name,
      addressCountry: "ES",
    },
      ...
      : {
          about: {
            ...
            ...(listing.bedrooms != null
              ...
              : {}),
            // `built_m2` is the figure a buyer compares against Idealista;
            // `usable_m2` is display-only and would understate the property
            // by 10–15% in a structured-data comparison.
            ...(listing.builtM2
