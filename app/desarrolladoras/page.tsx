...
const DESCRIPTION =
  "Byggherrar som bygger i Spanien: deras projekt, i vilka städer och i vilket byggskede de befinner sig.";

const STAGE_LABEL: Record<string, string> = {
  en_pozo: "Projektstadiet",
  en_construccion: "Under uppförande",
  entrega_inmediata: "Klar för inflyttning",
};
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        subtitle="Vem som står bakom varje projekt. Innan du reserverar en enhet i projektstadiet, kolla vad byggherren byggt tidigare och i vilket skede varje projekt är."
      />

      <Section>
        {developers.length === 0 ? (
          <div className="mk-empty">
            <p>Det finns inga byggherrar med publicerade projekt ännu.</p>
      ...
      <CtaBand
        ...
        text="Publicera ditt projekt med alla enheter, byggskede och betalningsplan."
